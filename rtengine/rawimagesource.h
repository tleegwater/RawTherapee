...
protected:
    ...
    void dcb_correction(float (*tile)[3], const uint8_t* map, int x0, int y0);
    void dcb_pp(float (*tile)[3], int x0, int y0);
    void dcb_correction2(float (*tile)[3], const uint8_t* map, int x0, int y0);
    void dcb_restore_red_blue(float (*tile)[3], int x0, int y0, float** rawData);
    void dcb_refinement(float (*tile)[3], const uint8_t* map, int x0, int y0);
